#!/usr/bin/env python3
"""
build_v50.py — Fix S50, S51, S65/S66/S67.

Base: outputs/ultimate_presentation_v49.pptx  (94 slides)
v49 (94) → v50 (94 slides):
  S50  embedding_linear_map.png     — removed by-condition groups, removed title, 9.5"×4.2"
  S51  cross_ensemble_prediction.png — target R² filter added, ylim starts at 0
  S65  e07_e23_bucket_signal.png    — regenerated (bucket analysis rerun)
  S66  e07_e23_bucket_gpv.png       — shared y-axis scale across both subplots
  S67  e07_e23_bucket_covariation.png — regenerated (bucket analysis rerun)
"""
import os, zipfile
...
SRC  = os.path.join(root, 'outputs', 'ultimate_presentation_v49.pptx')
OUTS = [
    os.path.join(root, 'outputs', 'ultimate_presentation_v50.pptx'),
    '/mnt/c/Users/amits/Desktop/ultimate_presentation_v50.pptx',
]
