#!/usr/bin/env python3
"""
build_v51.py — Fix S36 panel-label/title overlap.

Base: outputs/ultimate_presentation_v50.pptx  (94 slides)
v50 (94) → v51 (94 slides):
  S36  freq_trace_example.png  — removed subplot titles (overlapped panel labels A/B),
                                  shortened ax_fast y-label to 'Residual'
"""
import os, zipfile
...
SRC  = os.path.join(root, 'outputs', 'ultimate_presentation_v50.pptx')
OUTS = [
    os.path.join(root, 'outputs', 'ultimate_presentation_v51.pptx'),
    '/mnt/c/Users/amits/Desktop/ultimate_presentation_v51.pptx',
]
...
UPDATES = [
    ('Example Plots',  os.path.join(mdir, 'freq_trace_example.png'), 'S36'),
]
