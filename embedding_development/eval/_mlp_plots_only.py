...
RUN_GLOBAL_PV    = False    # method 1 — semantic groups
RUN_COND_PV      = False    # method 2 — semantic groups
RUN_IG           = False    # method 3 — semantic + signed
RUN_GROUPED_PV   = False    # method 4 — supergroups of semantic vars
RUN_PER_LEVEL    = False    # method 5 — per-categorical-level decomposition
RUN_DRY_RUN      = False    # verification checks before full run
RUN_EVOLUTION    = False    # section A — temporal encoding evolution across sessions
RUN_DISCOVERY    = False    # section B — automated discovery of interesting pairs
