#!/usr/bin/env python3
"""
build_v29.py  —  Regenerate E07/E23 bucket slides with GPV/R² threshold (principled).

v28 (86) → v29 (86 slides, same count):
...
SRC  = os.path.join(root, 'outputs', 'ultimate_presentation_v28.pptx')
OUTS = [
    '/mnt/c/Users/amits/Desktop/ultimate_presentation_v29.pptx',
    os.path.join(root, 'outputs', 'ultimate_presentation_v29.pptx'),
]
...
print(f'Opened v28: {len(prs.slides)} slides')
