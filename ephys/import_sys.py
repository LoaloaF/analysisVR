...
def create_stim_sine_sequence(dac=0, amplitude=25, f=1000, ncycles=10, nreps=3):
	seq = maxlab.Sequence()
...
def main():
	...
	PATH = "/mnt/SpatialSequenceLearning/Simon/impedance/device_headmount_new3EpoxyWalls/impedance_rec_GP_bonded_PBS_grounded"
	PATH = "/mnt/SpatialSequenceLearning/Simon/impedance/device_headmount_new3EpoxyWalls/impedance_rec2_noGP"
	PATH = "/mnt/SpatialSequenceLearning/Simon/impedance/device_headmount_implanted/impdance_rec3_Saline_sine"
	...
	sine_stim_seq = create_stim_sine_sequence()
