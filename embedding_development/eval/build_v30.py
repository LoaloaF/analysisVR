#!/usr/bin/env python3
"""
build_v30.py  —  S64 scatter: η²(best feature) vs GPV/R² closes the co-variation story.

v29 (86) → v30 (86 slides, same count):
  S64 figure replaced: scatter of η²(best joint feature, sup.cond) vs GPV(best feature)/R².
  Best feature = argmax η²×GPV/R² per session. E07: speed. E23: mostly speed/rot.vel.
  Colour-coded by feature; feature key in footnote.
...
SRC  = os.path.join(root, 'outputs', 'ultimate_presentation_v29.pptx')
OUTS = [
    '/mnt/c/Users/amits/Desktop/ultimate_presentation_v30.pptx',
    os.path.join(root, 'outputs', 'ultimate_presentation_v30.pptx'),
]
...
print(f'Opened v29: {len(prs.slides)} slides')
