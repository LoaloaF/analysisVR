#!/usr/bin/env python3
"""
build_v27.py  —  Replace 3 E07/E23 slides (v26 S62-S64) with bucket-structured versions.

v26 (86) → v27 (86 slides, same count):
  Remove old S62-S64 (the "three_slide_analysis" figures):
...
SRC  = os.path.join(root, 'outputs', 'ultimate_presentation_v26.pptx')
OUTS = [
    '/mnt/c/Users/amits/Desktop/ultimate_presentation_v27.pptx',
    os.path.join(root, 'outputs', 'ultimate_presentation_v27.pptx'),
]
...
print(f'Opened v26: {len(prs.slides)} slides')

# Step 1: remove the three old slides (search by title fragment, always remove from top)
OLD_FRAGMENTS = [
    "Supervisor's Variables Do Show",   # S62
    "Our Model Detects It",             # S63
    "Co-varies With Theirs",            # S64
]
