...
from .data_selection_components import (
    ...
    plot_type_component,
    p1100_double_rewards_filter_component,
...
from ..plots import plot_StayPerformance
...
def render(app: Dash, global_data: dict, vis_name: str) -> html.Div:
    ...
    plot_type, PLOT_TYPE_ID = plot_type_component(vis_name)
    double_r, DOUBLE_R_ID = p1100_double_rewards_filter_component(vis_name)
    ...
    @app.callback(
        ...
        Input(PLOT_TYPE_ID, 'value'),
        Input(DOUBLE_R_ID, 'value'),
        )
    def update_plot(selected_paradigm, selected_animal, session_range,
                    metric_max, outcome_filter, cue_filter, trial_filter, which_plot_type,
        ...
        fig = plot_StayPerformance.render_plot(data,
                                               metric_max, which_plot_type,
                                               double_reward_filter)
        return fig
